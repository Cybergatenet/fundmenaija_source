    ...
    const handleSubmit = () => {
        ...
        if(username === '' || pwd === ''){
            ...
            .then(res => {
                if(res.data.status !== false && res.data.message === "Login Success"){
                ...
                }else if(res.data.isAdmin === true && res.data.status !== false && res.data.message === "Admin Login Sucess"){
                    // create session && redirect to dashboard
                    // console.log(res.data);
                    ...
                    // Navigate('/dash', res.data);
                    window.location.replace('https://fundmenaija.com/Admin/Dashboard.php');
                }else{
                    swal({
                        title: "Account Alert!",
